...
class test_appbackground(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_appbackground")
        ...
        bkgnd="background-image: url(" + '/opt/sdr/gnuradio/gr-guiextra38/examples/gnuradio_logo.png' + "); background-repeat: repeat_n; background-position: " + "center" + ";"
...
def main(top_block_cls=test_appbackground, options=None):
