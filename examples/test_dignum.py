...
class test_dignum(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_dignum")
        ...
        self.qtgui_edit_box_msg_0 = qtgui.edit_box_msg(qtgui.FLOAT, '90e6', 'Freq', True, True, 'value')
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_msgdigctl_win = guiextra.MsgDigitalNumberControl(lbl = 'Frequency', minFreqHz = 30e6, maxFreqHz=1700e6, parent=self,  ThousandsSeparator=",",backgroundColor="black",fontColor="white", varCallback=self.set_freq)
        self._freq_msgdigctl_win.setValue(100e6)
        ...
        self.msg_connect((self.qtgui_edit_box_msg_0, 'msg'), (self.freq, 'valuein'))
...
def main(top_block_cls=test_dignum, options=None):
